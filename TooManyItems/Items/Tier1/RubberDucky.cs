...
namespace TooManyItems.Items.Tier1
{
    internal class RubberDucky
    {
        ...
        private static void GenerateItem()
        {
            ...
            GameObject prefab = AssetManager.bundle.LoadAsset<GameObject>("RubberDucky.prefab");
            ...
            itemDef.pickupIconSprite = AssetManager.bundle.LoadAsset<Sprite>("RubberDucky.png");
