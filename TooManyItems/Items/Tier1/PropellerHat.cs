...
namespace TooManyItems
{
    internal class PropellerHat
    {
        ...
        internal static void Init()
        {
            ...
            displayRules.Add("mdlHuntress", Utils.GenerateItemDisplayRule(itemDef, "Head", new Vector3(0f, 0.3f, 0.023f), new Vector3(0f, 40f, 10f), new Vector3(1.2f, 1.2f, 1.2f)));
            displayRules.Add("mdlBandit2", Utils.GenerateItemDisplayRule(itemDef, "Hat", new Vector3(0f, 0.4f, 0.023f), new Vector3(0f, 40f, 10f), new Vector3(1.2f, 1.2f, 1.2f)));
            displayRules.Add("mdlToolbot", Utils.GenerateItemDisplayRule(itemDef, "Head", new Vector3(0f, 0.8f, 0.023f), new Vector3(0f, 50f, 10f), new Vector3(15f, 15f, 15f)));
            ...
            displayRules.Add("mdlMage", Utils.GenerateItemDisplayRule(itemDef, "Head", new Vector3(0f, 0.18f, 0.023f), new Vector3(0f, -20f, 10f), new Vector3(1.5f, 1.5f, 1.5f)));
            displayRules.Add("mdlMerc", Utils.GenerateItemDisplayRule(itemDef, "Head", new Vector3(0f, 0.3f, 0.023f), new Vector3(0f, -20f, 10f), new Vector3(1.5f, 1.5f, 1.5f)));
            displayRules.Add("mdlTreebot", Utils.GenerateItemDisplayRule(itemDef, "PlatformBase", new Vector3(0f, 1.45f, 0.023f), new Vector3(0f, -20f, 10f), new Vector3(1f, 1f, 1f)));
            ...
            displayRules.Add("mdlCroco", Utils.GenerateItemDisplayRule(itemDef, "Head", new Vector3(0f, 0.5f, 0.023f), new Vector3(0f, -20f, 10f), new Vector3(1f, 1f, 1f)));
            displayRules.Add("mdlCaptain", Utils.GenerateItemDisplayRule(itemDef, "Stomach", new Vector3(0f, 0.5f, 0.023f), new Vector3(0f, -20f, 10f), new Vector3(1f, 1f, 1f)));
            displayRules.Add("mdlRailGunner", Utils.GenerateItemDisplayRule(itemDef, "Head", new Vector3(0f, 0.5f, 0.023f), new Vector3(0f, -20f, 10f), new Vector3(1f, 1f, 1f)));
            displayRules.Add("mdlVoidSurvivor", Utils.GenerateItemDisplayRule(itemDef, "Neck", new Vector3(0f, 0.5f, 0.023f), new Vector3(0f, -20f, 10f), new Vector3(1f, 1f, 1f)));
